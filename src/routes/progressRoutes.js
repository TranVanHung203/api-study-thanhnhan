 ...
 */
// Hoc vuot: lay toan bo cau hoi theo classId (gom tat ca quiz thuoc class do)
router.get('/overstudy/questions', getAdvancedLearningQuestionsController);

/**
 * @swagger
 * /progress/overstudy/submit:
 *   post:
 ...
 *         description: Lop khong ton tai
 */
// Hoc vuot: nop bai. Dat >=80% se goi selectClassController de gan classId cho user
